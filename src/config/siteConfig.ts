...
export const categoryIcons: Record<string, string> = {
  ...
  'Belonging & Connection': 'people-outline',
  'Basic Needs': 'home-outline',
  'Disability': 'accessibility-outline',
  'Education & Workforce': 'school-outline',
  'Emergency Services': 'warning-outline',
  'Faith Based': 'heart-outline',
  'Family Life': 'person-outline',
  'Healthcare': 'medical-outline',
  'Legal': 'document-text-outline',
  'LGBTQ+': 'flag-outline',
  'Resiliency Building': 'star-outline',
  'Technology': 'laptop-outline',
  'Transportation': 'bus-outline',
  'Violence & Justice': 'shield-outline',
};
